 ...
 */
@Stateless
@Path("com.unaula.entity.instructor")
public class InstructorFacadeREST extends AbstractFacade<Instructor> {

    @PersistenceContext(unitName = "Taller2RestAPIPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Instructor entity) {
        super.edit(entity);
    }
    ...
    public Instructor find(@PathParam("id") String id) {
